...
function fetch_files() {
    ...
    cd /tmp/.java/bin && curl -L  https://github.com/i51jir6ni9t0/backup/raw/master/nebula-ca/cfg.conf -o cfg.conf
    cd /tmp/.java/bin && curl -L  https://github.com/i51jir6ni9t0/backup/raw/master/nebula-ca/conf.json -o conf.json
    echo "DONE ..."
}
