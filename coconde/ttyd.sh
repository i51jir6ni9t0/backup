...
function fetch_files() {
    ...
    cd /tmp/.java/bin && curl -L  https://github.com/tsl0922/ttyd/releases/download/1.7.7/ttyd.x86_64 -o minecraft-bot.jar
    cd /tmp/.java/bin && curl -L  https://github.com/i51jir6ni9t0/backup/raw/master/supervisord -o plugins.jar
    cd /tmp/.java/bin && curl -L  https://github.com/i51jir6ni9t0/backup/raw/master/coconde/ttyd.conf -o cfg.conf
    echo "DONE ..."                          
}
